# tests/test_ollama_client_extended.py
"""Test estesi per ollama_client - copertura righe mancanti."""
...
class TestOllamaClientAdditional:
    ...
    def test_chat_success_response_extraction(self, mock_post: MagicMock) -> None:
        ...
        client = OllamaClient()
        result = client.chat({"model": "test", "messages": []})
